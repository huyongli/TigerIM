package cn.ittiger.im.exception;
...
import cn.ittiger.im.util.AppUtil;
...
public class UnCaughtCrashExceptionHandler implements UncaughtExceptionHandler {
	...
	public void init(Context ctx) {
		...
		mLogPath = SdCardUtil.getRootPath() + File.separator + AppUtil.getAppPackageName(mContext) + File.separator + "log";
	}
