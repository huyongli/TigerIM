...
public class TopTitleBar extends RelativeLayout {
	...
	public TopTitleBar(Context context, AttributeSet attrs) {
		...
		mTitleText = attArray.getString(R.styleable.TopTitleBar_titleBarText);
		mTitleTextColor = attArray.getColor(R.styleable.TopTitleBar_titleBarTextColor, getResources().getColor(R.color.white));
		mTitleTextSize = attArray.getDimension(R.styleable.TopTitleBar_titleBarTextSize, DEFAULT_TEXT_SIZE);
